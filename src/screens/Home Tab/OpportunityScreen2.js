...
const AddOpportunity2Screen = ({ navigation, route: {
  params: { item },
}, }) => {
  ...
  return (
    <ScrollView keyboardShouldPersistTaps="handled">
      ...
      {isUpdate?<Pressable onPress={()=>{
        ...
        <Text style={{textAlign:'center', color:Colors.DEFAULT_BLUE,fontWeight:'bold'}}> + Make Quatation</Text>
      </Pressable>:''}
...
export default AddOpportunity2Screen